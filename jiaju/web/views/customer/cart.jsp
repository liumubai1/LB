    ...
    <script>
        $(function () {
            ...
            $(".qtybutton").on("click", function () {
                ...
                if ($button.text() === "+") {
                    if (oldValue<${sessionScope.furnStock}) {
                        var newVal = parseFloat(oldValue) + 1;
                    }else {
                        newVal = ${sessionScope.furnStock};
                    }
                } else {
...
<div class="cart-main-area pt-100px pb-100px">
    <div class="container">
        <h3 class="cart-page-title">你的购物车商品</h3>
        <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td class="product-quantity">
                                            <div class="cart-plus-minus">
                                                <input furnId="${entry.value.id}" furnStock="${entry.value.id}" class="cart-plus-minus-box"
                                        ...
                                        <td class="product-remove">
                                            <a class="delete" href="cartServlet?action=delItem&id=${entry.value.id}"><i class="icon-close"></i></a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </C:if>
