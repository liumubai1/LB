    ...
    <script>
        $(function () {
            $("button.add-to-cart").click(function () {
                var furnStock = $(this).attr("furnStock");
                if (furnStock == 0) {
                    return false;
                }
                //获取到点击的furn-id
                ...
                //(2)
                //使用jquery发出ajax请求，得到数据进行局部更新，解决刷新页面的效率低的问题
                $.getJSON("cartServlet", {
                    "action": "addItemByAjax",
                    "id": furnId
                }, function (data) {
                    if (data.url == undefined) { //没有返回url，表示已经登录，不会走到过滤器的判断代码
            ...
            <div class="row align-self-center">
                ...
                <div class="col-auto align-self-center">
                    <div class="header-logo">
                        <a href="index.jsp"><img src="assets/images/tit/1.png" alt="Site Logo"/></a>
                    </div>
                </div>
                <!-- Header Logo End -->
                ...
                <div class="col align-self-center">
                    <div class="header-actions">
                        ...
                        <c:if test="${not empty sessionScope.member}">
                            ...
                            <div class="header-bottom-set dropdown">
                                <a href="orderServlet?action=getOrder">订单管理</a>
                            </div>
                            <div class="header-bottom-set dropdown">
                        ...
                        <a href="views/customer/cart.jsp"
                           class="header-action-btn header-action-btn-cart pr-0">
                            ...
                            <%--sessionScope.cart.totalCount这里本质是调用cart对象的getTotalCount方法--%>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6" data-aos="fade-up"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            ...
                                            <c:if test="${furn.stock>0 && sessionScope.itemCount != furn.stock}">
                                                <button title="Add To Cart" furnStock="${furn.stock}"
                                                        furnId="${furn.id}" class="add-to-cart">
                                                    Add To Cart
                                                </button>
                                            </c:if>
